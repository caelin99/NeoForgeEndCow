...
import static com.caelin.endercattle.client.ModEntities.ENTITY_TYPES;
...
//        String namespace = ModEntities.ENTITY_TYPES.getNamespace();
//
//        if (namespace.equals(EnderCattle.MODID)) {
