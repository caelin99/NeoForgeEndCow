...
public class GlowingEyesLayer extends RenderLayer<LivingEntityRenderState, CowModel> {
    ...
    public GlowingEyesLayer(RenderLayerParent<LivingEntityRenderState, CowModel> parent, EntityModelSet modelSet) {
        super(parent);
    }
